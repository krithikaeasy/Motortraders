                        ...
                        <div class="row">
							...
							<div class="col-md-6">
				            	<div class="form-group">
                                    ...
                                    <br/>
									<label>Min</label>
                                    <select name="minimum" class="form-group col-md-4">
                                        <option value=" "> </option>
                                        <option>5000</option>
                                        <option>10000</option>
                                    </select>
                                    <label> Max</label> 
                                    <select name="maximum" class="form-group col-md-4">
                                        <option value=" "> </option>
                                        <option>5000</option>
                                        <option>10000</option>
                                        <option>15000</option>
                        ...
                        <div class="row">
							...
							<div class="col-md-6">
				            	<div class="form-group">
                                    ...
                                    <br/>
									<label>From</label>
                                    <select name="from" class="form-group col-md-4">
                                        <option value=" "> </option>
                                        <option>1995</option>
                                        <option>1996</option>
                                        <option>1997</option>
                                    ...
                                    <label> To</label> 
                                    <select name="to" class="form-group col-md-4">
                                        <option value=" "> </option>
                                        <option>1995</option>
                                        <option>1996</option>
                                        <option>1997</option>
                        ...
                        <div class="row">
							...
							<div class="col-md-6">
				            	<div class="form-group">
                                    ...
                                    <br/>
									<label>Min</label>
                                    <select name="minimum1" class="form-group col-md-4">
                                        <option value=" "> </option>
                                        <option>5000</option>
                                        <option>10000</option>
                                    </select>
                                    <label> Max</label> 
                                    <select name="maximum1" class="form-group col-md-4">
                                        <option value=" "> </option>
                                        <option>5000</option>
                                        <option>10000</option>
                                        <option>15000</option>
